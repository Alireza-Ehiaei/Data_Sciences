...
### Reading data
pop = pd.read_csv(r"https://raw.githubusercontent.com/Alireza-Ehiaei/Machine_learning/master/WPP2019_POP_F01_1_TOTAL_POPULATION_BOTH_SEXES.csv", encoding='latin-1')
